...
class Mega:
    ...
    def _download_file(self,
        ...
        return self._execute_download(file_data, k, iv, meta_mac, dest_path=dest_path, dest_filename=dest_filename)
    
    def _execute_download(self, file_data, k, iv, meta_mac, dest_path=None, dest_filename=None, verbose=False):
